...
import MobileCarousel from '../common/mobileCarousel/MobileCarousel.vue'
import type { ISliders } from '../common/mobileCarousel/mobileTypes'
import ProgressBar from '../common/ProgressBar.vue'

export default {
  setup() {
    const slides = ref<ISliders>({
      images: [
    ...
    <div class="container">
      <div class="hero-data">
        ...
        <div class="hero-description">
          ...
          <InputComponent placeholder="Enter your Email Address" :isError="isError" @on-change="onTextChnageHadler" />
